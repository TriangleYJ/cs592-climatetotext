...
if str(REPO_ROOT) not in sys.path:
    # Allow running the script directly (e.g., `python inference_simple`) without PYTHONPATH tweaks.
    sys.path.append(str(REPO_ROOT))

import torch
from climate_to_text_stage2.dataset import default_image_loader
from climate_to_text_stage2.mtl_weatherqa.data_utils import build_image_transform, select_samples_gemini
from climate_to_text_stage2.mtl_weatherqa.model_utils import load_stage2_lora
